...
export const fakeData = [
  ...
  {
    kind: 'youtube#searchResult',
    etag: 'iKI_ari7EcaxYkCEgkHMLFZ1f-U',
    id: {
      kind: 'youtube#video',
      videoId: 'RRSYfDfujGk',
    },
    snippet: {
      publishedAt: '2020-01-30T03:04:42Z',
      channelId: 'UCPiLe0hwTpPdvwKqQOzgs0A',
      title: '개발과 코딩을 배우기 전, 알아야 할 5가지',
      description: '코드스테이츠 CPO 구일모님의 이야기를 들어봅시다',
      thumbnails: {
        default: {
          url: 'https://i.ytimg.com/vi/RRSYfDfujGk/default.jpg',
          width: 120,
          height: 90,
        },
      },
  ...
  {
    kind: 'youtube#searchResult',
    etag: 'YjLLo0TejYm0jiP2D5qqgvySPvw',
    id: {
      kind: 'youtube#video',
      videoId: 'p5vI5OrLJU8',
    },
    snippet: {
      publishedAt: '2020-07-31T13:40:07Z',
      channelId: 'UCPiLe0hwTpPdvwKqQOzgs0A',
      title: '자바스크립트로 할 수 있는 7가지',
      description: '코드스테이츠 엔지니어 이호용님이 자바스크립트에 대해 소개합니다',
      thumbnails: {
        default: {
          url: 'https://i.ytimg.com/vi/p5vI5OrLJU8/default.jpg',
          width: 120,
          height: 90,
        },
      },
